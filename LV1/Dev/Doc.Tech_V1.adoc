...
image::InkedUSE_CASE_CréerClient.jpg[][title=Use Case de créer client]

[.text-justify]

Cette fonctionnalité permet aux guichetiers et aux chefs d'agence de créer un nouveau client dans l'agence. 
