...
Gestion des clients --> Rechercher clients --> Rechercher --> choisir Client --> voir compte --> voir prélèvements --> Nouveau prélèvements --> Saisir Bénéficiaire --> Saisir Montant --> Saisir Date--> Choisir le compte sur ID Compte --> Valider.
...
Gestion des clients --> Rechercher clients --> Rechercher --> choisir Client --> voir compte --> voir prélèvements --> Saisir Numéro du compte si nécessaire --> Rechercher

La saisie du numéro de compte n'est pas nécessaire elle est là pour affiner les recherches à un compte ou plusieurs

==== C. Modifier des prélèvements automatique
[.text-justify]

Gestion des clients --> Rechercher clients --> Rechercher --> choisir Client --> voir compte --> voir prélèvements --> Saisir Numéro du compte si nécessaire --> Rechercher --> Cliquer sur le prélevement automatique --> Modifier --> Changer les informations dans les champs ( Informations valides )

==== D. Supprimer les prélèvements automatique
[.text-justify]

Gestion des clients --> Rechercher clients --> Rechercher --> choisir Client --> voir compte --> voir prélèvements --> Saisir Numéro du compte si nécessaire --> Rechercher --> Cliquer sur le prélevement automatique --> Supprimer


=== 9. Effectuer un Débit exceptionnel
[.text-justify]
